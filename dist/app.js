...
;// CONCATENATED MODULE: ./src/static/commandList.js
var commandList = {
  Control: [{
    text: 'Wait for ^val',
    val: true
...
/* harmony default export */ var static_commandList = (commandList);
...
var reducer_reducer = function reducer() {
  ...
  switch (action.type) {
    ...
    case redux_actionTypes.REMOVE_TAB:
      ...
      var currTabIndex = filteredTab.indexOf(state.currentTab);
...
;// CONCATENATED MODULE: ./src/utils/dragDrop.js
...
function drop(ev) {
  ...
  var v = ev.dataTransfer.getData('dragVal');
...
;// CONCATENATED MODULE: ./src/utils/getIcon.js
var getIcon = function getIcon(data, loc) {
  var _data$text;
...
;// CONCATENATED MODULE: ./src/components/CommandBlock.js



function CommandBlock(_ref) {
  var text = _ref.text;
  var JSXText = null;
...
/* harmony default export */ var components_CommandBlock = (CommandBlock);
...
const NumericInput = (0,react.forwardRef)(({ value, min, max, step = 1, clampAfterBlur, roundAfterBlur, onValueChange, onChange, onBlur, ...props }, ref) => {
...
;// CONCATENATED MODULE: ./src/components/SidebarBlock.js
...
var SidebarBlock = function SidebarBlock(_ref) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    ...
    }, /*#__PURE__*/react.createElement(components_CommandBlock, {
      text: getIcon(_d, 0),
      icon: _d !== null && _d !== void 0 && _d.icon ? "true" : "false"
    }), getIcon(_d, 1) && /*#__PURE__*/react.createElement(Icon, {
      name: getIcon(_d, 1),
      size: 15,
      className: "text-green-600 mx-2 my-1"
    }), _d.val ? /*#__PURE__*/react.createElement(NumericInput, {
      value: val[i],
    ...
    }) : null, /*#__PURE__*/react.createElement(components_CommandBlock, {
      text: getIcon(_d, 2)
    }));
  }));
};
...
/* harmony default export */ var components_SidebarBlock = (SidebarBlock);
...
function Sidebar() {
  ...
  }, "Commands "), Object.keys(static_commandList).map(function (blockName) {
    return /*#__PURE__*/react.createElement(components_SidebarBlock, {
      key: blockName,
      title: blockName,
      data: static_commandList[blockName]
    });
  }));
}
...
function MidArea() {
  ...
  }, /*#__PURE__*/react.createElement(components_TabList, null), tabs.map(function (tab) {
    return /*#__PURE__*/react.createElement("div", {
      key: tab + 'div',
      onDrop: drop,
      onDragOver: allowDrop,
...
;// CONCATENATED MODULE: ./src/utils/pushSprite.js
...
/* harmony default export */ var pushSprite = (mergeSprite);
...
var sleepFor = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(time) {
...
var moveCat = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(cat, val) {
...
var jumpCat = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3(cat) {
...
var controlCommands = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(cmd, val) {
    var splitCmd;
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = _context.t0 === 'Wait' ? 4 : 7;
            break;
...
var motionCommands = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(cmd, val) {
    var splitCmd, cat;
    return regenerator_default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = _context2.t0 === 'Move' ? 6 : _context2.t0 === 'Jump' ? 8 : _context2.t0 === 'Turn' ? 10 : 12;
            break;
...
var looksCommands = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3(cmd, val) {
...
var commandParser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(commands) {
...
var commandRunner = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(cmd) {
    return regenerator_default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", controlCommands(cmd.cmdText, cmd.cmdVal));
          ...
          case 2:
            ...
            return _context2.abrupt("return", motionCommands(cmd.cmdText));
          ...
          case 4:
            ...
            return _context2.abrupt("return", looksCommands(cmd.cmdText, cmd.cmdVal));
          ...
          case 6:
            ...
            return _context2.abrupt("return", motionCommands(cmd.cmdText, cmd.cmdVal));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return utils_commandParser(pushSprite(commands));
